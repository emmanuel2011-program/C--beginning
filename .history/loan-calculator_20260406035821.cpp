...
// this function ensures that the user inputs a positive integer for the number of months, and it will keep prompting until a valid input is received. it serves as the security 
